...
function InvestmentsList() {
  ...
  if (isError) return <p className="text-sm text-red-600">Failed to load investments.</p>;
        ...
        <li key={investment.id} className="py-3">
          <div className="flex items-center justify-between">
            <button
              ...
              className="text-left"
            >
              <span className="font-medium text-slate-900">{investment.name}</span>
...
function ProjectionScenarios() {
  ...
  return (
    <section className="rounded-lg border border-slate-200 bg-white p-4">
      <h2 className="mb-3 text-lg font-semibold text-slate-900">Retirement projection scenarios</h2>
      ...
      {isError && <p className="text-sm text-red-600">Failed to load projection scenarios.</p>}
      <ul className="divide-y divide-slate-100">
...
export function InvestmentsPage() {
  return (
    <div className="space-y-4">
      ...
      <section className="rounded-lg border border-slate-200 bg-white p-4">
        <h2 className="mb-3 text-lg font-semibold text-slate-900">Add investment</h2>
        <AddInvestmentForm />
      </section>

      <section className="rounded-lg border border-slate-200 bg-white p-4">
        <h2 className="mb-3 text-lg font-semibold text-slate-900">Holdings</h2>
        <InvestmentsList />
      </section>
